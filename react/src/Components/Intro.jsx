...
const Intro = () => {
  ...
  const githublink = ()=>{
    window.open("https://github.com/sanjukumari-tech/sanjukumari")
  }

  const emaillink = ()=>{
    window.location.href = 'mailto:sanju080598@gmail.com';
  }

  const linkedinlink = ()=>{
    window.open("www.linkedin.com/in/sanju-kumari-a73149264")
  }
